...
class NightStreetOfflineIndexPT(tasti.Index):

    def get_num_workers(self):
        return 0

    def get_cache_dir(self):
        return '/srv/data/jbang36/tasti_data/cache/tasti_pt'
...
class NightStreetOfflineConfigPT(tasti.IndexConfig):
    def __init__(self):
        super().__init__()
...
if __name__ == '__main__':
    config = NightStreetOfflineConfigPT()
    index = NightStreetOfflineIndexPT(config)
    index.init()
